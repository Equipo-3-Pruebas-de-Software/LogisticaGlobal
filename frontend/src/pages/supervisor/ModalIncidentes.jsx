...
import tecnicos from "../../mockups/tecnicos.json";
...
export const ModalIncidentes = ({onClose, incidente}) => {
    ...
    const [tecnicoAsignado, setTecnicoAsignado] = useState(incidente.tecnico || null);
    ...
    const handleGuardar = () => {
        ...
        console.log({ prioridad, gravedad, tecnicoAsignado });
      };
            ...
            <section className='info-zone'>
                ...
                {incidente.gravedad && 
                        ...
                        <ul>
                            ...
                            <li><b>Robot involucrado: </b><span>{incidente.robots}</span></li>
                    ...
                    {!incidente.gravedad &&
                        <>
                            ...
                            <Dropdown 
                                ...
                                options={tecnicos} 
                                onChange={(e) => setTecnicoAsignado(e.value)} 
                                optionLabel="nombre"
